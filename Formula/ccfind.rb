class Ccfind < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/hiboma/ccfind/releases/download/v0.1.0/ccfind-aarch64-apple-darwin"
      sha256 "ef218a92a330a587f2dc24b61f6caa8dd0775a2d015415d383ce6ab20b638b21"
    end

    on_intel do
      url "https://github.com/hiboma/ccfind/releases/download/v0.1.0/ccfind-x86_64-apple-darwin"
  ...
  on_linux do
    on_arm do
      url "https://github.com/hiboma/ccfind/releases/download/v0.1.0/ccfind-aarch64-unknown-linux-gnu"
      sha256 "ccd4535faac4c9bcd248e6c1c9d042cb2169d2a2476e873f40035ea43562a19a"
    end

    on_intel do
      url "https://github.com/hiboma/ccfind/releases/download/v0.1.0/ccfind-x86_64-unknown-linux-gnu"
