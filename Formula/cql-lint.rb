class CqlLint < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/hiboma/cql-lint/releases/download/v0.1.1/cql-lint-v0.1.1-aarch64-apple-darwin.tar.gz"
      sha256 "593c532bf196ea11202103c57b07315a82c0e4269994719d398565bddedb6ee9"
    end

    on_intel do
      url "https://github.com/hiboma/cql-lint/releases/download/v0.1.1/cql-lint-v0.1.1-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/hiboma/cql-lint/releases/download/v0.1.1/cql-lint-v0.1.1-x86_64-unknown-linux-gnu.tar.gz"
