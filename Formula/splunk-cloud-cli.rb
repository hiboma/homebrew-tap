class SplunkCloudCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/hiboma/splunk-cloud-cli/releases/download/v0.1.0/splunk-cloud-cli-aarch64-apple-darwin.tar.gz"
      sha256 "8fb9cab6a4c6a664b6745e24c67786321db74e4d237ecb7d905fca17061101e5"
    end

    on_intel do
      url "https://github.com/hiboma/splunk-cloud-cli/releases/download/v0.1.0/splunk-cloud-cli-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/hiboma/splunk-cloud-cli/releases/download/v0.1.0/splunk-cloud-cli-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "a20b133dc146beed083928674ae203709052aed360dbd79387fafb458c3dd08d"
    end

    on_intel do
      url "https://github.com/hiboma/splunk-cloud-cli/releases/download/v0.1.0/splunk-cloud-cli-x86_64-unknown-linux-gnu.tar.gz"
