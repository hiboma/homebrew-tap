class CloudappsCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/hiboma/cloudapps-cli/releases/download/v0.9.2/cloudapps-cli-aarch64-apple-darwin.tar.gz"
      sha256 "9b73deeda3e30e5d47304c84ab0a69c58e9cd17e63a8b72db46dda5d869d5793"
    end

    on_intel do
      url "https://github.com/hiboma/cloudapps-cli/releases/download/v0.9.2/cloudapps-cli-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/hiboma/cloudapps-cli/releases/download/v0.9.2/cloudapps-cli-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "0c459a86d791b05ac90aa73b7558cee57dfd08891f8026b63b70be6a7a6eb771"
    end

    on_intel do
      url "https://github.com/hiboma/cloudapps-cli/releases/download/v0.9.2/cloudapps-cli-x86_64-unknown-linux-gnu.tar.gz"
