class SplLint < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/hiboma/spl-lint/releases/download/v0.1.2/spl-lint-v0.1.2-aarch64-apple-darwin.tar.gz"
      sha256 "783c2c05ea1045c96b2fd79a9d18201198a3c4606aafd2de487d618900c4cc48"
    end

    on_intel do
      url "https://github.com/hiboma/spl-lint/releases/download/v0.1.2/spl-lint-v0.1.2-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/hiboma/spl-lint/releases/download/v0.1.2/spl-lint-v0.1.2-x86_64-unknown-linux-gnu.tar.gz"
